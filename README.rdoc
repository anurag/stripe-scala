...
Add the stripe-scala dependency:
    ...
    val stripeScala = "com.stripe" %% "stripe-scala" % "1.1.0"
...
In the +stripe-scala+ directory, run <tt>sbt -DstripeApiKey=myTestApiKey test</tt>, using your stripe test secret key.
