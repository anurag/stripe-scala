...
= Installation
The current release is distributed for Scala 2.9.0 and 2.9.0-1. Add stripe-scala as a dependency in sbt or Maven:
...
See http://stripe.com/api for the most up-to-date documentation.
